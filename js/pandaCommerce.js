...
function onclickHandler(){
  ...
  handlerStatus.innerText = "success";
}
...
const btnBuyNow = document.getElementsByClassName('btn');
...
secondImage.addEventListener("mouseenter", function(){
  secondImage.src = "images/second.png";
})
const image = document.getElementById('image-3');
image.addEventListener("mouseenter", function(){
  image.src = "images/mahabub.png";
...
subscribeSection.addEventListener("dblclick", function(){
  subscribeSection.style.backgroundColor = 'gray';
